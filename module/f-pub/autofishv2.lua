...
local FISHING_CONFIGS = {
    ["Fast"] = {
        chargeTime = 1.0,
        chargeAttempts = 5,        -- Invoke charge 3x to ensure it works
        waitBetween = 2,
        rodSlot = 1,
        castSpamDelay = 0.05,      -- Spam cast every 50ms
        maxCastTime = 7,           -- Max time to spam cast before timeout
        completionSpamDelay = 0.05, -- Spam completion every 50ms
        maxCompletionTime = 20,     -- Stop completion spam after 8s
